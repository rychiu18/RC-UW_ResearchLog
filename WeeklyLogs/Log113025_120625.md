...
* Tidal characteristics are slightly different between Tokepoint and sensor at Sasha's location (~30km upstream) (Fig. 5)
...
* NTR at Sasha's sensor shows same trend as Tokepoint, indicating that storm surge influences water levels up to at least this point (Fig. 6)

![SashasSensorTokepoint](../Figures/120425meeting/sashassensor_october2025_wl.png)<br>
Figure 5: Water levels at Tokepoint (NAVD88) and HOBO sensor (relative depth).

![SashasSensorNTR](../Figures/120425meeting/sashassensor_october2025_wl_reconstructed.png)<br>
Figure 6: Reconstructed water levels for HOBO sensor vs. measured (top). NTR calculated at Sasha's sensor vs. Tokepiont's NTR (bottom). 
