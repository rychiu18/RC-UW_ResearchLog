...
* Using a ratio between the converging parameter and water depth (Lb/ho), he found two regimes:
	1) Lb/ho < 4,500 (strong convergent channel leading to amplified tidal range)<br>
		* Increasing ho should make it amplified more unless some external force dampens it <br>
	2) Lb/ho > 4,500 (shallow converging channel resulting in damped tidal range)<br>
